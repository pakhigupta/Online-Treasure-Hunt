...
<html>
    ...
    <body align="center">
        ...
        <img src="images/level2 photo1.jpg" alt='Photo' id="code" height="300px" width="300px">
        <img src="images/level2 photo2 Kedarnath Tragedy.jpg" alt='Photo' id="code" height="300px" width="300px">
        ...
        <%
            if(request.getParameter("submit")!=null)
            {
                ...
                ans=ans.toLowerCase();
                ans=ans.trim();
                String query  = "select answer from Answers where questionNumber = 2";
                ...
                if(ans.equals(rs.getString(1)))
                {
                   // out.print("<h3>Correct Answer!</h3>");
                    ...
                    String updateQuestion = "update Login set questionNumber = 3 where username = '"+username +"'";
                    jdbc.DAOLayer.updateData(updateQuestion);
                    session.setAttribute("url", "Ques3.jsp?Pepper");
