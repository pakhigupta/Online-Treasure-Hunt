...
<html>
    ...
    <body align="center">
        <!-- Focus on the Image Name-->
        <img src="images/level1 New Clock.jpeg" alt='New Clock' id="code" height="300px" width="300px">
        ...
        <%
            if(request.getParameter("submit")!=null)
            {
                ...
                ans=ans.toLowerCase();
                ans=ans.trim();
                String query  = "select answer from Answers where questionNumber = 1";
                ...
                if(ans.equals(rs.getString(1)))
                {
                    ...
                    String updateQuestion = "update Login set questionNumber = 2 where username = '"+username +"'";
                    jdbc.DAOLayer.updateData(updateQuestion);
                    session.setAttribute("url", "Ques2.jsp");
